    ...
    class Program
    {
        static void Main(string[] args)
        {
           bool decrypt = false;  //Am I encrypting or decrypting?
            ...
            int Value=0; // new value for the derotating
            ...
            else
            {
                ...
                FileReader(Value, fileName, decrypt);
        ...
        //making a method of the file reader 
        // Everytime it reads a file it decrypts the text
        static void FileReader(int n, string fileName, bool decrypt)
        {
           ...
           {
                StreamReader Userfile = new System.IO.StreamReader(fileName.ToString());
                Words[0] = Userfile.ReadToEnd();
                Userfile.Close();
                Words = Test(Words[0], n);
                foreach(string OU in Words)
                {
                    IOut += OU;
                }
                File.WriteAllText(fileName,IOut);
           }
